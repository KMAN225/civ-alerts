...
export default function Home({ selectedSector, setSelectedSector, onLocateIssue, mapCenter, issues = [], onIssueAdded }) {
  ...
  return (
    <div className="min-h-screen bg-gray-50/50 dark:bg-gray-950/50">
      <section className="py-12 px-6 border-b border-gray-100 dark:border-gray-800 bg-white dark:bg-gray-900">
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-3 gap-8">
          <div className="lg:col-span-2">
            <div className="bg-white dark:bg-gray-900 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-800 overflow-hidden max-h-[500px] overflow-y-auto">
          ...
          <div className="space-y-6">
                      ...
                      <button
                        ...
                        className={`px-3 py-2.5 rounded-xl text-[10px] font-bold transition-all duration-200 border ${
                          selectedSector === sector
                            ...
                            : 'bg-white dark:bg-gray-800 text-gray-500 dark:text-gray-400 border-gray-100 dark:border-gray-700 hover:border-ciGreen/30 hover:text-ciGreen'
                        }`}
                      >
                      ...
                      <button
                        ...
                        className={`px-3 py-2.5 rounded-xl text-[10px] font-bold transition-all duration-200 border ${
                          selectedPriority === prio
                            ...
                            : 'bg-white dark:bg-gray-800 text-gray-500 dark:text-gray-400 border-gray-100 dark:border-gray-700 hover:border-ciOrange/30 hover:text-ciOrange'
                        }`}
                      >
                        {prio}
                      </button>
            ...
            {selectedSector !== 'Tous' && sectorData[selectedSector] && (
              <div className="p-5 bg-gradient-to-br from-ciGreen/[0.04] to-transparent rounded-2xl border border-ciGreen/10 dark:border-ciGreen/20 animate-slide-up">
      ...
      <section className="py-16 px-6 max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-10">
        ...
        <div className="lg:col-span-8 space-y-8" id="explorer">
          <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-4 border-b border-gray-100 dark:border-gray-800 pb-6">
            <div>
              <h2 className="text-2xl sm:text-3xl font-black text-ciDark dark:text-white tracking-tight">
          ...
          {filteredIssues.length > 0 ? (
            ...
            <div className="col-span-2 py-16 text-center bg-white dark:bg-gray-900 rounded-2xl border-2 border-dashed border-gray-200 dark:border-gray-700">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div className="space-y-8">
              <div>
                ...
                <h2 className="text-3xl sm:text-4xl font-black text-ciDark dark:text-white tracking-tight">
