                      ...
                      <button
                        ...
                        className={`px-3 py-2.5 rounded-xl text-[10px] font-bold transition-all duration-200 border ${
                          selectedSector === sector
                            ...
                            : 'bg-gray-50 text-gray-500 border-gray-200 hover:border-ciGreen/30 hover:text-ciGreen'
                        }`}
                      >
                      ...
                      <button
                        ...
                        className={`px-3 py-2.5 rounded-xl text-[10px] font-bold transition-all duration-200 border ${
                          selectedPriority === prio
                            ...
                            : 'bg-gray-50 text-gray-500 border-gray-200 hover:border-ciOrange/30 hover:text-ciOrange'
                        }`}
                      >
                        {prio}
                      </button>
      ...
      <section className="py-16 px-6 max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-10">
        ...
        <div className="lg:col-span-8 space-y-8" id="explorer">
          ...
          {filteredIssues.length > 0 ? (
            ...
            <div className="col-span-2 py-16 text-center bg-gray-50 rounded-2xl border-2 border-dashed border-gray-200">
            ...
            <div className="space-y-8">
              ...
              <div className="grid grid-cols-1 gap-4">
                {[
                  ...
                  <div key={idx} className="flex gap-4 p-5 bg-gray-200 rounded-2xl border border-gray-200 hover:shadow-md hover:border-gray-200 transition-all duration-300 group">
