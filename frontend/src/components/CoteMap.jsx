...
const regionColors = [
  { d: 'M85 40 Q90 30 100 35 Q130 20 160 30 Q180 25 200 35 Q230 30 250 45 Q260 60 265 80 Q270 100 260 120 Q265 140 250 160 Q245 180 230 200 Q220 220 200 240 Q185 255 170 260 Q155 265 140 258 Q125 252 115 240 Q100 225 85 210 Q70 195 60 175 Q50 155 45 130 Q40 110 45 85 Q50 65 65 50 Z', color: '#059669', opacity: 0.06 },
  { d: 'M120 90 Q135 70 160 75 Q175 80 190 95 Q200 110 195 130 Q190 145 175 155 Q160 160 145 155 Q130 145 125 125 Q120 110 120 90 Z', color: '#F59E0B', opacity: 0.08 },
  { d: 'M90 170 Q110 160 130 170 Q150 180 160 200 Q165 215 155 230 Q140 245 120 240 Q100 235 90 220 Q80 205 85 185 Z', color: '#059669', opacity: 0.05 },
  ...
  { d: 'M185 140 Q205 130 225 140 Q240 155 245 175 Q240 195 225 210 Q210 220 195 210 Q180 195 180 170 Q180 155 185 140 Z', color: '#F59E0B', opacity: 0.06 },
];
  ...
  return (
    <div className="relative w-full bg-gradient-to-br from-gray-50 to-white overflow-hidden">
          ...
          return (
            <g key={i}>
              ...
              <circle
                ...
                cy={city.y}
                r={dotRadius}
                fill={city.size === 'lg' ? '#F59E0B' : '#059669'}
                stroke="white"
                strokeWidth="2"
                className="drop-shadow-sm"
              />
              <text
                ...
                fill={city.size === 'lg' ? '#F59E0B' : '#6B7280'}
      ...
      <div className="absolute bottom-3 left-4 right-4 flex items-center justify-between text-[9px] text-gray-400 font-medium">
        ...
        <span className="flex items-center gap-1.5">
          <span className="w-1.5 h-1.5 rounded-full" style={{ backgroundColor: '#059669' }}></span>
          Villes principales
        </span>
      </div>
    </div>
