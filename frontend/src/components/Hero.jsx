      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 w-full">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          <div className="lg:col-span-7 space-y-8 animate-slide-up">
            <div className="inline-flex items-center gap-2 bg-gray-50/70 border border-gray-200 px-3 py-1.5 rounded-full shadow-sm backdrop-blur-sm">
            ...
            <div className="flex flex-wrap gap-4 pt-2">
              ...
              <a
                href="#explorer"
                className="group inline-flex items-center gap-2 bg-gray-50 text-ciDark border-2 border-gray-200 px-8 py-4 rounded-2xl font-bold text-sm uppercase tracking-wide hover:border-ciGreen hover:text-ciGreen transition-all duration-300 active:scale-[0.98] shadow-sm"
              >
          ...
          <div className="lg:col-span-5 space-y-6">
            ...
            <div className="flex items-center gap-4 px-4 py-3 bg-gray-50/70 backdrop-blur-sm rounded-2xl border border-gray-200 shadow-sm">
        ...
        <div className="mt-16 sm:mt-20 grid grid-cols-2 md:grid-cols-4 gap-4 sm:gap-6 animate-fade-in">
          {statItems.map((stat, idx) => (
            <div
              key={idx}
              className="group relative bg-gray-50/60 backdrop-blur-sm border border-gray-200 rounded-2xl p-5 sm:p-6 hover:shadow-xl hover:shadow-gray-200/50 hover:border-ciGreen/20 transition-all duration-300 hover:-translate-y-0.5"
            >
