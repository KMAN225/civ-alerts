...
const IssueCard = memo(function IssueCard({ issue, onDelete }) {
  ...
  return (
    <div className="group bg-gray-50 rounded-2xl border border-gray-200 hover:border-ciGreen/20 hover:shadow-xl hover:shadow-ciGreen/5 transition-all duration-300 hover:-translate-y-1 overflow-hidden">
      ...
      <div className="p-6">
        <div className="flex items-start justify-between gap-4 mb-4">
          <div className="flex items-center gap-2 flex-wrap">
            ...
            <span className="inline-flex items-center px-2.5 py-1 rounded-lg text-[10px] font-bold uppercase tracking-wider bg-gray-50 text-gray-600 border border-gray-200">
              {issue.sector}
            </span>
        ...
        <div className="flex items-center justify-between pt-2 border-t border-gray-50">
          ...
          <div className="flex items-center gap-2">
            <button
              onClick={vote}
              className="group/btn inline-flex items-center gap-2 bg-gray-50 border border-gray-200 px-4 py-2 rounded-xl text-xs font-bold text-gray-600 hover:bg-ciOrange hover:text-white hover:border-ciOrange transition-all duration-200 active:scale-90"
            >
            ...
            {isOwner && (
              <button
                ...
                className="group/btn inline-flex items-center gap-2 bg-gray-50 border border-red-200 px-3 py-2 rounded-xl text-xs font-bold text-red-500 hover:bg-red-500 hover:text-white hover:border-red-500 transition-all duration-200 active:scale-90"
