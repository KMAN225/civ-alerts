    ...
    <>
      <nav
        className={`fixed top-0 left-0 right-0 z-50 transition-all duration-500 ${
          scrolled
            ? 'bg-gray-50/90 backdrop-blur-xl shadow-lg shadow-black/5'
            : 'bg-transparent'
        }`}
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-20">
            ...
            <div className="hidden md:flex items-center gap-3">
              <div className="flex items-center gap-2 bg-gray-50/10 backdrop-blur-sm rounded-xl p-1 border border-white/10">
                <a
                  href="/"
                ...
                <div className="relative">
                  ...
                  {isSectorsOpen && (
                    <div
                      ...
                      className="absolute top-full left-0 mt-2 w-56 bg-gray-50 rounded-2xl shadow-2xl shadow-black/10 border border-gray-200 py-2 animate-scale-in overflow-hidden z-50"
                    >
            ...
            <div className="flex items-center gap-3">
              {user ? (
                <div className="hidden sm:flex items-center gap-3">
                  <div className="flex items-center gap-2 px-3 py-1.5 bg-gray-50/10 backdrop-blur-sm rounded-xl border border-white/10">
                  ...
                  <button
                    ...
                    className={`px-3 py-1.5 rounded-xl font-bold text-[10px] uppercase tracking-wider transition-all duration-200 ${
                      scrolled
                        ...
                        : 'bg-gray-50/10 text-white/80 hover:bg-gray-50/20 hover:text-white'
                    }`}
                  >
                    Déconnexion
                  </button>
              ...
              <button
                ...
                className={`md:hidden p-2 rounded-xl transition-colors ${
                  scrolled ? 'bg-gray-100 text-gray-600' : 'bg-gray-50/10 text-white'
                }`}
              >
        ...
        {isMobileMenuOpen && (
          <div className="md:hidden bg-gray-50/95 backdrop-blur-xl border-t border-gray-200 shadow-xl animate-slide-down">
